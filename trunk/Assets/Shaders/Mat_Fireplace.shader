...
/////// Diffuse:
                ...
                finalColor += diffuseLight * tex2D(_node_2,TRANSFORM_TEX(node_58.rg, _node_2)).rgb;
/// Final Color:
...
/////// Diffuse:
                ...
                finalColor += diffuseLight * tex2D(_node_2,TRANSFORM_TEX(node_59.rg, _node_2)).rgb;
/// Final Color:
